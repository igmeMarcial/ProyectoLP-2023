                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="highlight-thumb">
                                ...
                                <div class="highlight-info">
                                    <h4 class="highlight-title">PASIÓN POR SERVIR</h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="highlight-thumb">
                                ...
                                <div class="highlight-info">
                                    <h4 class="highlight-title">OBSESIÓN POR LA CALIDAD</h4>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="highlight-thumb">
                                ...
                                <div class="highlight-info">
                                    <h4 class="highlight-title">MENTALIDAD DE APRENÍZ</h4>
            ...
            <section id="marcas">
            	<div class="container">
            		<div class="marcas-title">
            			<h3>Conoce más de nuestras marcas
            			<img src="http://admin.trabajaenngr.com.pe/photos/shares/NGR/ngr-title-decorator.png"/> </h3>
            		...
            		<div class="marcas-slider">
            			<div class="marcas-list-content d-flex justify-content-center align-items-center"  >
            				<div class="slick-track marcas-list d-flex justify-content-center align-items-center" style="opacity: 1; width: 100%;">
	            				<div class="slick-slide slick-current slick-center" data-slick-index="0" aria-hidden="true" style="width: 119px;"><div><a href="/empresa/bembos-001" tabindex="-1" style="width: 100%; display: inline-block;"><img src="http://admin.trabajaenngr.com.pe/photos/shares/bembos/bembos-logo-carousel.png" class="img-fluid"></a></div></div>
	            				<div class="slick-slide" data-slick-index="1" aria-hidden="true" style="width: 149px;"><div><a href="/empresa/don-belisario-006" tabindex="-1" style="width: 100%; display: inline-block;"><img src="http://admin.trabajaenngr.com.pe/photos/shares/don-belisario/don-belisario-logo-carousel.png" class="img-fluid"></a></div></div>
	            				<div class="slick-slide" data-slick-index="2" aria-hidden="true" style="width: 149px;"><div><a href="/empresa/popeyes-007" tabindex="-1" style="width: 100%; display: inline-block;"><img src="http://admin.trabajaenngr.com.pe/photos/shares/popeyes/popeyes-logo-carousel20.png" class="img-fluid"></a></div></div>
	            				<div class="slick-slide" data-slick-index="3" aria-hidden="true" style="width: 149px;"><div><a href="/empresa/papa-johns-009" tabindex="-1" style="width: 100%; display: inline-block;"><img src="http://admin.trabajaenngr.com.pe/photos/shares/papa-johns/papa-johns-logo-carousel.png" class="img-fluid"></a></div></div>
	            				<div class="slick-slide" data-slick-index="4" aria-hidden="true" style="width: 149px;"><div><a href="/empresa/chinawok-008" tabindex="-1" style="width: 100%; display: inline-block;"><img src="http://admin.trabajaenngr.com.pe/photos/shares/china-wok/chinawok-logo-carousel.png" class="img-fluid"></a></div></div>
	            				<div class="slick-slide" data-slick-index="5" aria-hidden="true" style="width: 149px;"><div><a href="/empresa/dunkin-donuts-010" tabindex="-1" style="width: 100%; display: inline-block;"><img src="http://admin.trabajaenngr.com.pe/photos/shares/dunkin-donuts/dunkin-donuts-carrusel20.png" class="img-fluid"></a></div></div>
		...
		<div class="container">
			...
			<div class="row justify-content-around">
				...
				<div class="col-lg-3 ml-auto">
					<div class="widget text-start link-container-footer">
						<h3 class="footer-subTitle">Por categoría</h3>
						<ul class="list-unstyled float-left links">
							<li><a class="links" href="#">Política de datos personales</a></li>
							<li><a class="links" href="#">
												Encargados del tratamiento</a></li>
							<li><a class="links" href="#">Empresas y socios estratégicos</a></li>
				...
				<div class="col-lg-3">
					<div class="widget text-start">
						...
						<address class="links" >Direccion no lo sé</address>
			...
			<div class="row mt-5">
				<div class="col-12 text-center">
					<p class="mb-0">Copyright &copy;<script>document.write(new Date().getFullYear());</script>. Todos los Derechos Reservados. &mdash; Creado y desarrollado por <a href="#">Igme</a> <!-- License information: igmreGroup -->
					</p>
				</div>
			</div> <!-- /.container -->
		</div> <!-- /.site-footer -->
