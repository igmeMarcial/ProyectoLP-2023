...
<html>
			...
			<nav class="header-nav ms-auto">
				<ul class="d-flex align-items-center">
					...
					<li class="nav-item dropdown">
						...
						<!-- Final notificación Dropdown Items -->
					</li>
	...
	<div class="content-wrapper">
		<div class="container-xxl flex-grow-1 container-p-y">
			<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Listado /</span> Proveedor</h4>
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="data-table-list">
				...
				<div class="table-responsive">
					...
					<thead>
							<tr role="row">
								<th class="sorting_asc th-title text-uppercase text-xs  font-weight-bold opacity-7 " tabindex="0" aria-controls="data-table-basic" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 190px;">RUC</th>
								<th class="sorting th-title text-uppercase text-xs  font-weight-bold opacity-7 " tabindex="0" aria-controls="data-table-basic" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 292px;">Razón Social</th>
								<th class="sorting th-title text-uppercase text-xs font-weight-bold opacity-7 " tabindex="0" aria-controls="data-table-basic" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 145px;">Categoria</th>
								<th class="sorting th-title text-uppercase text-xs font-weight-bold opacity-7 " tabindex="0" aria-controls="data-table-basic" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 52px;">Teléfono</th>
								<th class="sorting th-title text-uppercase text-xs font-weight-bold opacity-7 " tabindex="0" aria-controls="data-table-basic" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 125px;">Email</th>
								<th class="sorting th-title text-uppercase text-xs font-weight-bold opacity-7 " tabindex="0" aria-controls="data-table-basic" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 116px;">Tipo Solicitud</th>
						...
						<tbody>
						<c:forEach var="proveedor" items="${listadoProv}">
							<tr role="row" class="odd">
								<td class="sorting_1 text-secondary text-dark font-weight-bold "><c:out value="${proveedor.ruc}"></c:out></td>
								<td class="text-secondary text-dark  font-weight-bold"><c:out value="${proveedor.razonSocial}"></c:out></td>
								<td class="text-secondary text-dark  font-weight-bold"><c:out value="${proveedor.categoria}"></c:out></td>
								<td class="text-secondary text-dark font-weight-bold"><c:out value="${proveedor.telefono}"></c:out></td>
								<td class="text-secondary text-dark font-weight-bold"><c:out value="${proveedor.email}"></c:out></td>
								<td class="text-secondary text-dark font-weight-bold"><c:out value="${proveedor.tipoSolitud}"></c:out></td>
