 ...
 * Generated at: 2023-04-14 16:54:25 UTC
...
public final class ActualizarCategoria_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<h4 class=\"fw-bold py-3 mb-4\"><span class=\"text-muted fw-light\">Actualizar/</span> Categoria</h4>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<form action=\"ControladorCategoria?accion=actualizarCategoria\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input name=\"idCategoria\" type=\"hidden\"value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${getCategoria.idCategoria}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\" />\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tvalue=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${getCategoria.nombreCategoria}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"mb-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label class=\"form-label\" for=\"TEXTnEW\">Descripcion</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-group input-group-merge\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control inputCustom borderColorInput\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"TEXTnEW\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Razón Social\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\taria-label=\"default\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-icon-default-fullname2\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tvalue=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${getCategoria.descripcion}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\trequired\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<button type=\"submitUpdated\" class=\"btn btn-primary\">Actualizar</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
