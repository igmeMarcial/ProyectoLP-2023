 ...
 * Generated at: 2023-03-24 04:20:30 UTC
...
public final class RegistrarEmpleado_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"input-group input-group-merge\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span id=\"basic-icon-default-phone2\" class=\"input-group-text labelCustom borderColorInput\"><i class=\"ri-folder-add-line\"></i></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input name=\"cargoNuevo\"\" type=\"text\" id=\"cargoNuevo\"\" class=\"form-control phone-mask inputCustom borderColorInput\" placeholder=\"select\" aria-label=\"Admin\" aria-describedby=\"basic-icon-default-cargo\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"mb-3\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"mb-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label class=\"form-label\" for=\"testNuevo\">cargos</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"input-group input-group-merge\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<span id=\"basic-icon-default-company2\" class=\"input-group-text labelCustom borderColorInput\"><i class=\"ri-folder-add-line\"></i></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<select id=\"testNuevo\" name=\"testNuevo\" class=\"form-select inputCustom borderColorInput\" aria-label=\"Default select example\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option selected>Selecciona</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
