...
<html>
	...
	<div class="content-wrapper">
		<div class="container-xxl flex-grow-1 container-p-y">
			<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Listado /</span>Categorias</h4>
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="data-table-list">
				...
				<div class="table-responsive">
					...
					<thead>
							<tr role="row">
								<th class="sorting_asc th-title text-uppercase text-xs  font-weight-bold opacity-7 " tabindex="0" aria-controls="data-table-basic" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 190px;">idCategoria</th>
								<th class="sorting th-title text-uppercase text-xs  font-weight-bold opacity-7 " tabindex="0" aria-controls="data-table-basic" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 292px;">Nombre</th>
								<th class="sorting th-title text-uppercase text-xs font-weight-bold opacity-7 " tabindex="0" aria-controls="data-table-basic" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 145px;">Descripcion</th>							
						...
						<c:forEach var="categoria" items="${listadoCategorias}">
							<tr role="row" class="odd">
								<td class="sorting_1 text-secondary text-dark font-weight-bold "><c:out value="${categoria.idCategoria}"></c:out></td>
								<td class="text-secondary text-dark  font-weight-bold"><c:out value="${categoria.nombreCategoria}"></c:out></td>
								<td class="text-secondary text-dark  font-weight-bold"><c:out value="${categoria.descripcion}"></c:out></td>
									...
									<div class="dropdown">
										...
										<div class="dropdown-menu menu-dropdown-b" style="">
												<a class="dropdown-item" href="
																<c:url value="ControladorCategoria">
															      <c:param name="accion" value="leerCategoria" />
															 <c:param name="cod" value="${categoria.idCategoria}" />
															     </c:url>"><i class="ri-edit-line"></i> Editar
															                                                   
												</a>
														<input type="hidden" id="codigo"  value="${categoria.idCategoria}">
															<a id="deleteData" class="dropdown-item" href="<c:url value="ControladorCategoria">
															<c:param name="accion" value="eliminarCategoria"/> 
															<c:param  name="cod" value="${categoria.idCategoria}"/>
						...
						<tfoot>
							<tr>
								<th rowspan="1" colspan="1" class="th-footer">ID</th>
								<th rowspan="1" colspan="1" class="th-footer">Nombre</th>
								<th rowspan="1" colspan="1" class="th-footer">Descripcion</th>					
			...
			$("tr #deleteData").click(function (e){
				...
				Swal.fire({
					  ...
					  if (result.isConfirmed) {
					    ...
					    setTimeout(function(){
					    	parent.location.href ="ControladorCategoria?accion=listarCategorias"
					    },1800);
					  }
					})									
			})
			function eliminar (cod){		
				var url = "ControladorCategoria?accion=eliminarCategoria&cod=" + cod;			
				$.ajax({
					type: 'POST',
					url: url,
					async: true,
