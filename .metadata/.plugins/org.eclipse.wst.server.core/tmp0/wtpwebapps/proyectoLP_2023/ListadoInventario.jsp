...
<html>
	...
	<div class="content-wrapper">
		<div class="container-xxl flex-grow-1 container-p-y">
			<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Listado /</span> Inventarios</h4>
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="data-table-list">
				...
				<div class="table-responsive">
					...
					<thead>
							<tr role="row">
								<th class="sorting_asc th-title text-uppercase text-xs  font-weight-bold opacity-7 " tabindex="0" aria-controls="data-table-basic" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 100px;">Id inventario</th>
								<th class="sorting th-title text-uppercase text-xs  font-weight-bold opacity-7 " tabindex="0" aria-controls="data-table-basic" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 150px;">Ticket</th>
						...
						<tbody>
						<c:forEach var="inventario" items="${listadoInventarios}">
							<tr role="row" class="odd">
								<td class="sorting_1 text-secondary text-dark font-weight-bold "><c:out value="${inventario.idInventario}"></c:out></td>
								<td class="text-secondary text-dark  font-weight-bold"><c:out value="${inventario.nombreTicket}"></c:out></td>
						...
						<tfoot>
							<tr>
								...
								<th rowspan="1" colspan="1" class="th-footer">Nombre Ticket</th>
			...
			$("tr #deleteData").click(function (e){
				...
				Swal.fire({
					  ...
					  if (result.isConfirmed) {
					    ...
					    setTimeout(function(){
					    	parent.location.href = "ControladorInventario?accion=listarInventarios"
					    },1800);
					  }
					})									
			})
			function eliminar (cod){		
				var url = "ControladorInventario?accion=eliminarInventario&cod=" + cod;			
				$.ajax({
					type: 'POST',
					url: url,
					async: true,
