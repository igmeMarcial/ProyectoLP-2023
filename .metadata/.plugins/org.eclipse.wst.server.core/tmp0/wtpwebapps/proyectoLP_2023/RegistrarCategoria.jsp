		...
		<main id="main" class="main main-nuevoEmpleado">
			<div class="content-wrapper">
				<div class="container-xxl flex-grow-1 container-p-y">
					<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Registrar/</span> Categoria</h4>
						...
						<div class="row">
							<div class="col-xl">
								<div class="card mb-4">
									...
									<div class="card-body">
										<form action="ControladorCategoria?accion=nuevoCategoria" method="post">
											<div class="mb-3">
