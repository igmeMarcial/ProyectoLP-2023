...
<main id="main" class="main main-nuevoEmpleado">
	<div class="content-wrapper">
		<div class="container-xxl flex-grow-1 container-p-y">
			<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Registrar/</span> Equipo</h4>
				...
				<div class="row">
					<div class="col-xl">
						<div class="card mb-4">
							...
							<div class="card-body">
								<form action="ControladorEquipo?accion=nuevoEquipo" method="post">
									<div class="mb-3">
										...
										<div class="input-group input-group-merge">
											...
											<input name="nombreE" type="text" class="form-control inputCustom borderColorInput" id="nombreNuevo" placeholder="Nombre" aria-label="Marcial" aria-describedby="basic-icon-default-fullname"  required/>
									...
									<div class="mb-3">
										...
										<div class="input-group input-group-merge">
											<span id="basic-icon-default-fullname2" class="input-group-text labelCustom borderColorInput"><i class="ri-folder-add-line"></i></span>
											<input name="marcaE" type="text" class="form-control inputCustom borderColorInput" id="apellidosNuevo" placeholder="Marca" aria-label="apellido" aria-describedby="basic-icon-default-fullname2" required/>
										</div>
									</div>
									<div class="mb-3">
										...
										<div class="input-group input-group-merge">
											<span id="basic-icon-default-fullname2" class="input-group-text labelCustom borderColorInput"><i class="ri-folder-add-line"></i></span>
											<input name="modeloE" type="text" class="form-control inputCustom borderColorInput" id="MODELONuevo" placeholder="Modelo" aria-label="apellido" aria-describedby="basic-icon-default-fullname2" required/>
										</div>
									</div>
									<div class="mb-3">
										...
										<select id="selectMenuForm" name="tipoE" aria-label="Default select" required>
										  <option value="1" selected>Tipo1</option>
										  <option value="2" selected>Tipo2</option>
									...
									<div class="mb-3">
										...
										<div class="input-group input-group-merge">
											...
											<input name="serieE" type="text" id="basic-icon-default-phone" class="form-control phone-mask inputCustom borderColorInput" placeholder="123456" aria-label="658 799 8941" aria-describedby="basic-icon-default-phone" required/>
										</div>
									</div>
									<div class="mb-3">
										...
										<div class="input-group input-group-merge">
											...
											<input name="ipE" type="text" id="IPNuevo" class="form-control phone-mask inputCustom borderColorInput" placeholder="192.168.0.1" aria-label="658 799 8941" aria-describedby="basic-icon-default-phone2" required/>
										</div>
									</div>														
