...
<main id="main" class="main main-nuevoEmpleado">
	<div class="content-wrapper">
		<div class="container-xxl flex-grow-1 container-p-y">
			<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Actualizar/</span>Equipo</h4>
					...
					<div class="col-xl">
						<div class="card mb-4">
							...
							<div class="card-body">
								...
								<form action="ControladorEquipo?accion=actualizarEquipo" method="post">
									<input name="idEquipo" type="hidden"value="${getEquipo.idEquipo}" />
									<div class="mb-3">
										...
										<div class="input-group input-group-merge">
											...
											<input name="nombreE" type="text" class="form-control inputCustom borderColorInput" id="nombreNuevo" placeholder="Nombre" aria-label="Marcial" aria-describedby="basic-icon-default-fullname"
											value="${getEquipo.nombre}"  required/>
									...
									<div class="mb-3">
										<label class="form-label" for="apellidosNuevo">Marca</label>
										<div class="input-group input-group-merge">
											<span id="basic-icon-default-fullname2" class="input-group-text labelCustom borderColorInput"><i class="ri-folder-add-line"></i></span>
											<input name="marcaE" type="text" class="form-control inputCustom borderColorInput" id="apellidosNuevo" placeholder="Marca" aria-label="apellido" aria-describedby="basic-icon-default-fullname2"
											value="${getEquipo.marca}" required/>
										</div>
									</div>
									<div class="mb-3">
										<label class="form-label" for="MODELONuevo">Modelo</label>
										<div class="input-group input-group-merge">
											<span id="basic-icon-default-fullname2" class="input-group-text labelCustom borderColorInput"><i class="ri-folder-add-line"></i></span>
											<input name="modeloE" type="text" class="form-control inputCustom borderColorInput" id="MODELONuevo" placeholder="Modelo" aria-label="apellido" aria-describedby="basic-icon-default-fullname2"
											value="${getEquipo.modelo}" required/>
										</div>
									</div>
									<div class="mb-3">
										<label class="form-label" for="selectMenuForm">Tipo:</label>
										<select id="selectMenuForm" name="tipoE" aria-label="Default select" required>
										  <option value="1" <c:if test="${getEquipo.tipo == '1'}" > selected </c:if> >Tipo1</option>
										  <option value="2" <c:if test="${getEquipo.tipo == '2'}" > selected </c:if> >Tipo2</option>
										  
										</select>																	    
									</div>							
									
									<div class="mb-3">
										<label class="form-label labelCustom" for="SERIENuevo" >Serie</label>
										<div class="input-group input-group-merge">
											<span id="SERIENuevo" class="input-group-text labelCustom borderColorInput"><i class="ri-folder-add-line"></i></span>
											<input name="serieE" type="text" id="basic-icon-default-phone" class="form-control phone-mask inputCustom borderColorInput" placeholder="123456" aria-label="658 799 8941" aria-describedby="basic-icon-default-phone" 
											value="${getEquipo.serie}" required/>
										</div>
									</div>
									<div class="mb-3">
										<label class="form-label labelCustom" for="IPNuevo">IP</label>
										<div class="input-group input-group-merge">
											<span id="basic-icon-default-phone2" class="input-group-text labelCustom borderColorInput"><i class="ri-folder-add-line"></i></span>
											<input name="ipE" type="text" id="IPNuevo" class="form-control phone-mask inputCustom borderColorInput" placeholder="192.168.0.1" aria-label="658 799 8941" aria-describedby="basic-icon-default-phone2" 
											value="${getEquipo.IP}" required/>
										</div>
									</div>														
