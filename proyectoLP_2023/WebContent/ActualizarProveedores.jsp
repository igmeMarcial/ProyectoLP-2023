						...
						<div class="row">
							<div class="col-xl">
								<div class="card mb-4">
									...
									<div class="card-body">
										<form action="ControladorProveedor?accion=actualizarProveedor" method="post">
										<input name="idProveedor" type="hidden"value="${getProveedor.idProveedor}" />
											<div class="mb-3">
											...
											<div class="mb-3">
												...
												<div class="input-group input-group-merge">
													...
													<input
														...
														value="${getProveedor.razonSocial}"
														required
													/>
												</div>
											</div>
											...
											<div class="mb-3" id="">
												...
												<div class="input-group input-group-merge">
													...
													<input
														...
														value="${getProveedor.tipoSolitud}"
														required
													/>
												</div>
											</div>
