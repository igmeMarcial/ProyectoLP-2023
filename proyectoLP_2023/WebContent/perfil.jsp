					...
					<div class="col-lg-4">
						<div class="card mb-4">
							<div class="card-body text-center">
								...
								<p class="text-muted mb-4">Arequipa Cusco-Perú</p>
							...
							<div class="col-md-6">
								<div class="card mb-4 mb-md-0">
									<div class="card-body">
										...
										<p class="mt-4 mb-1" style="font-size: .77rem;">Tamaño de la empresae</p>
										<div class="progress rounded" style="height: 5px;">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <input name="idUsuario" type="hidden"value="${getUsuario.idUsuario}" />
											...
											<div class="mb-3">
												<label class="form-label" for="apellidosNuevo">contraseña</label>
												<div class="input-group input-group-merge">
